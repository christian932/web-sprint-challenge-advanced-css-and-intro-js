...
Coding without discrimination. It is accesible to everyone reguardless of color blindness, text size, screen size, etc
2. Talk about 3 different things you can do to ensure your website is accessible. 
- Make it so it works with a text size adjuster on chrome or anything else.
- Choose your colors in a way so that color blind people can see everything
- Make it so your webpage adjusts properly with screen size
3. How would you explain the concept of a variable to someone new to programming?
Variables hold data or a value that can be changed
4. What is the purpose of using functions in code?
Execute a task such as updating a variable or searching for data
